class Kyber < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/IanGordonOne/kyber/releases/download/v0.9.0/kyber-0.9.0-darwin-arm64.tar.gz"
      sha256 "fa304ac2b6bdd84eda1e0317d0a3156256b6d03dad81d5f49a3e591f3c0775e1"
    end
    on_intel do
      url "https://github.com/IanGordonOne/kyber/releases/download/v0.9.0/kyber-0.9.0-darwin-amd64.tar.gz"
